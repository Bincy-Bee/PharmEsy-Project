const nav =()=>{
    return `<header class="p-2 border text-lg">
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="user-cart flex">
            <div class="usermenu">
                <a href="" class="font-[400] hover:text-teal-500 relative mx-2"><i class="fa-solid fa-user text-sm pr-2 text-teal-500"></i><span id="user">User</span></a>
                <div class="absolute right-0 top-0 w-full h-full bg-white drop-shadow-2xl z-50 hidden" id="signuptab">
                    <div class="flex flex-wrap justify-between items-center bg-teal-600 p-3 relative">
                        <div class="login-bg">
                            <img src="../img/phaWsy.png" class="h-[70px] z-10" alt="">
                        </div>
                        <div class="bg">
                            <img src="../img/loginbgimg.svg" class="scale-[1] mt-3 mr-6" alt="">
                        </div>
                        <div class="signuptabclose absolute top-0 right-0">
                            <button class="p-4 text-[20px] bg-teal-600 text-white rounded-l-xl" id="signuptabclose"><i class="fa-solid fa-xmark"></i></button>
                        </div>
                    </div>
                ...
                <div class="absolute right-0 top-0 w-full h-full bg-white drop-shadow-2xl z-50 hidden" id="signintab">
                    <div class="flex flex-wrap justify-between items-center bg-teal-600 p-3 relative">
                        <div class="login-bg">
                            <img src="../img/phaWsy.png" class="h-[70px] z-10" alt="">
                        </div>
                        ...
                        <div class="signintabclose absolute top-0 right-0">
                            <button class="p-4 text-[20px] bg-teal-600 text-white rounded-l-xl" id="signintabclose"><i class="fa-solid fa-xmark"></i></button>
                        </div>
                    </div>
                ...
                <div class="absolute w-full h-[200px] top-[95px] right-0 p-6 bg-white drop-shadow-lg rounded-md border hidden" id="account">
            ...
            <div class="toggle">
              <span class="mx-2"><i class="fa-solid fa-bars text-teal-600" id="toggle"></i></span>
            </div>
        </div>
    </div>
</header>`
